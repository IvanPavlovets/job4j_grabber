...
/**
 * 1) Конфигурирование и начало работы происходит с создания экземпляра класс планировщика - Scheduler,
 * управляющего всеми работами. В объект Scheduler мы будем добавлять задачи, которые хотим выполнять периодически.
